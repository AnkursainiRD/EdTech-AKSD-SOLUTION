...
import StatsComponent from '../components/cors/about/StatsComponent'
import LearningGrid from '../components/cors/about/LearningGrid'
import ContactFormSection from '../components/cors/about/ContactFormSection'
...
function About() {
  return (
    ...
    //                         Our team of dedicated experts worked tirelessly to develop a robust and intuitive platform that combines cutting-edge technology with engaging content, fostering a dynamic and interactive learning experience.</p>
    //                 </div>

    //                 <div>
    //                     <h1>Our Mission</h1>
    //                     <p> Our mission goes beyond just delivering courses online. We wanted to create a vibrant community of learners, where individuals can connect, collaborate, and learn from one another. 
    //                         We believe that knowledge thrives in an environment of sharing and dialogue, and we foster this spirit of collaboration through forums, live sessions, and networking opportunities.</p>
    //                 </div>
    //             </div>
    //         </div>
    //     </section>
